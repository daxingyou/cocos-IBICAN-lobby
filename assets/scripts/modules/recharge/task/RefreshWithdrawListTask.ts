...
import { WithdrawOrderListResp } from "../../../protocol/protocols/protocols";
import BaseWaitingPanel from "../../../../libs/common/scripts/modules/tips/views/BaseWaitingPanel";
import WithdrawOrderListTask from "./WithdrawOrderListTask";
...
@ccclass
export default class RefreshWithdrawListTask extends BaseRefreshListTask<WithdrawOrderListResp> {
