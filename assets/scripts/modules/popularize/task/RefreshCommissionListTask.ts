...
@ccclass
export default class RefreshCommissionListTask extends BaseRefreshListTask<DirectCommissionResp> {
    ...
    async onTaskStart() {
        let requestRecordListTask = this.popularizeServer.requestDirectCommission();
