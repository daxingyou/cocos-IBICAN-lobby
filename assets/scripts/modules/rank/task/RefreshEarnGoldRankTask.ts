...
import {WinRankingListResp } from "../../../protocol/protocols/protocols";
...
@ccclass
export default class RefreshEarnGoldRankTask extends BaseRefreshListTask<WinRankingListResp> {
    ...
    async onTaskStart() {
        let requestRankListTask = this.rankServer.requestEarnGoldRank();
