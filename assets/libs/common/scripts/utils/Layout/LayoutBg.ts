...
@ccclass
export default class LayoutBg extends cc.Component {
    public beforeLayout: Function;
    setBeforeLayout(callBack: Function) {
        this.beforeLayout = callBack;
    }
    ...
    layout() {
        ...
        // }
        // !this.node.width && (this.node.width == this.node.width);
        // !this.node.height && (this.node.height == this.node.height);
    ...
    public afterLayout: Function;
    setAfterLayout(callBack: Function) {
        this.afterLayout = callBack;
    }
}