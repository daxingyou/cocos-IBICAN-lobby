...
export default class LobbyConstants extends Constants {
    ...
    // 服务器相关设置
    // 各种API的地址
    public readonly jpApiUrl:string = "http://uat.jinpin.com:8080/";

    // 客户端（web）地址
    public readonly jpClientUrl:string = "http://uat.jinpin.com:9090/"

    public readonly jpLobbyServerUrl:string = `ws://uat.jinpin.com:8080/lobby/myWebSocket`;

    // 更新服务器路径
    public readonly updatingServerUrl:string = `${this.jpClientUrl}Public/items/`;

    public readonly env: string = "uat";
}
