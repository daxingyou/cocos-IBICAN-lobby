...
-keep public class org.cocos2dx.** { *; }
-keep public class com.jp.utils.** { *; }

-dontwarn android.os.Build
-dontwarn com.fm.openinstall.activity.OpenInstallAppCompatActivity
-dontwarn com.fm.openinstall.activity.OpenInstallFragmentActivity
